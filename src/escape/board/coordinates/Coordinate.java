...
/**
 * This interface identifies an object as a Coordinate. It also defines the coordinate
 * types. MODIFIABLE: NO MOVEABLE: YES REQUIRED: YES You may extend this interface for
 * your internal use, but this is the public interface that all clients will use.
 */
